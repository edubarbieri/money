...
const ReceiptDateEditor = ({ data,  onSet, show, setShow }) => {
    ...
    useEffect(()=> {
        setReceiptData({date: new Date(), amount: data.amount});
    }, [data]);

    const onConfirm = () => {
        setShow(false);
        onSet(data, receiptData);
    }
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        ...
                        <h4 className="modal-title text-primary">{bundle('receipt.date')}</h4>
                    </div>
                    <div className="modal-body">
                        ...
                        <div className="input-group">
                            ...
                            <input type="number"
                                ...
                                step="any"
                                min="0"
                                onChange={event => setReceiptData({ ...receiptData, amount: event.target.value})} />
                            </div>
                        <Datepicker 
                            date={receiptData.date}
                            setDate={value => setReceiptData({...receiptData, date: value})}
...
export default ReceiptDateEditor;